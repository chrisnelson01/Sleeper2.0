...
import { ScrollView, SafeAreaView, Dimensions, TouchableOpacity, View, Text, StyleSheet } from "react-native";
          ...
          <View key={index} style={styles.chartContainer}>
            <TouchableOpacity onPress={() => toggleTeamExpansion(team.name)}>
              <View style={styles.teamHeader}>
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'white' }}>{team.name}</Text>
                <Ionicons
